    ...
    return (
        ...
        <div className="container mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="mailto:contato@webuildsites.com.br" className="bg-white text-[#0061aa] font-semibold py-3 px-8 rounded-lg hover:bg-gray-100 transition-colors duration-300">
              Enviar Mensagem
            </Link>
